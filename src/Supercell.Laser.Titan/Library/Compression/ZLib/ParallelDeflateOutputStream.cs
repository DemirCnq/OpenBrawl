namespace Supercell.Laser.Titan.Library.Compression.ZLib
{
    using System;
    ...
    public class ParallelDeflateOutputStream : Stream
    {
        ...
        // TraceBits.Write | TraceBits.WriteBegin | TraceBits.WriteDone | TraceBits.Lasercycle |
        // TraceBits.Fill | TraceBits.Flush | TraceBits.Session;

        // private TraceBits _DesiredTrace = TraceBits.WriteBegin | TraceBits.WriteDone |
        // TraceBits.Synch | TraceBits.Lasercycle | TraceBits.Session ;
        ...
        {
            this.TraceOutput(TraceBits.Lasercycle | TraceBits.Session, "-------------------------------------------------------");
            this.TraceOutput(TraceBits.Lasercycle | TraceBits.Session, "Create {0:X8}", this.GetHashCode());
        ...
        {
            this.TraceOutput(TraceBits.Lasercycle, "Dispose  {0:X8}", this.GetHashCode());
            this.Close();
            this._pool = null;
            this.Dispose(true);
        }
        ...
        private enum TraceBits : uint
        {
            ...
            Flush = 64,
            Lasercycle = 128, // constructor/disposer
