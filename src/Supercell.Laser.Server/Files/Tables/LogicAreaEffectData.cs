...
using Supercell.Laser.Server.Files.CsvHelpers;
    public class LogicAreaEffectData : CsvData
    {
        public LogicAreaEffectData(Row row, DataTable datatable) : base(row, datatable)
        {
        ...
        public string ExportNameTopRed { get; set; }
