...
using Supercell.Laser.Server.Files.CsvHelpers;
    public class LogicSkinConfData : CsvData
    {
        public LogicSkinConfData(Row row, DataTable datatable) : base(row, datatable)
        {
        ...
        public string ModelCNOverride { get; set; }
        ...
        public string StarPower1Effect { get; set; }

        public string StarPower2Effect { get; set; }
        ...
        public string AreaEffectAttack { get; set; }
