...
using Supercell.Laser.Server.Files.CsvHelpers;
    public class LogicLocaleData : CsvData
    {
        ...
        public string SelfHelpUrlCN { get; set; }

        public bool FallbackToHelpshift { get; set; }

        public bool FallbackToHelpshiftCN { get; set; }

        public string TermsAndServiceUrl_Tencent_android { get; set; }

        public string ParentsGuideUrl_Tencent_android { get; set; }

        public string PrivacyPolicyUrl_Tencent_android { get; set; }

        public string TermsAndServiceUrl_Tencent_ios { get; set; }

        public string ParentsGuideUrl_Tencent_ios { get; set; }

        public string PrivacyPolicyUrl_Tencent_ios { get; set; }

        public string TermsAndServiceUrl_Yoozoo { get; set; }

        public string ParentsGuideUrl_Yoozoo { get; set; }

        public string PrivacyPolicyUrl_Yoozoo { get; set; }

        public string DeviceMigrationSelfHelpUrl { get; set; }
    }
}
