            ...
            foreach (var property in data.GetType().GetProperties(BindingFlags.Instance |
                ...
                if (property.CanRead && property.CanWrite)
                {
                    ...
                    else if (property.PropertyType.IsGenericType)
                    {
                        ...
                        else if (property.PropertyType == typeof(CsvData) ||
                                 property.PropertyType.BaseType == typeof(CsvData))
                        {
                            var pData = (CsvData) Activator.CreateInstance(property.PropertyType);
                            LoadData(pData);
